...
export const MATRIX: Record<FileType, TargetFormat[]> = {
  ...
  rtf: docTargetsExcept("rtf").concat("odp", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  ...
  htmlz: docTargetsExcept().concat("image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
