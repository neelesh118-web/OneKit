...
export type TargetFormat =
  ...
  | "rtf" | "odt" | "odp" | "pptx" | "pptm" | "potx" | "ppsx" | "fb2" | "rst" | "tex"
...
export const TARGET_LABELS: Record<TargetFormat, string> = {
  ...
  rtf: "Rich Text (RTF)", odt: "OpenDocument text (ODT)", odp: "OpenDocument presentation (ODP)", pptx: "PowerPoint (PPTX)", pptm: "Macro-enabled PowerPoint (PPTM)", potx: "PowerPoint template (POTX)", ppsx: "PowerPoint slideshow (PPSX)", fb2: "FictionBook (FB2)",
...
export const MATRIX: Record<FileType, TargetFormat[]> = {
  ...
  pdf: ["text", "markdown", "html", "rst", "tex", "image-png", "image-jpeg", "image-webp", "image-avif", "image-gif", "image-ico", "image-bmp", "image-tiff", "image-svg", "image-psd", "image-icns", "image-ppm", "image-tga", "docx", "dotx", "epub", "rtf", "odt", "pptx", "pptm", "potx", "ppsx", "fb2", "txt-base64", "txt-hex"],
  docx: ["html", "markdown", "text", "pdf", "dotx", "epub", "csv", "xlsx", "rtf", "odt", "pptx", "odp", "fb2", "rst", "tex", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp", "txt-base64", "txt-hex"],
  docm: ["html", "markdown", "text", "pdf", "docx", "epub", "rtf", "odt", "pptx", "fb2", "image-png", "image-jpeg", "txt-base64", "txt-hex"],
  dotx: ["html", "markdown", "text", "pdf", "docx", "epub", "rtf", "odt", "pptx", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp", "txt-base64", "txt-hex"],
  xlsx: tableTargetsExcept("xlsx").concat("image-png", "image-jpeg", "image-gif", "image-svg", "image-webp", "image-avif", "image-bmp", "xlsm"),
  xlsm: tableTargetsExcept().concat("image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  xls: tableTargetsExcept("xls").concat("image-png", "image-jpeg", "image-gif", "image-svg", "image-webp", "image-avif", "image-bmp", "xlsm"),
  ods: tableTargetsExcept("ods").concat("image-png", "image-jpeg", "image-gif", "image-svg", "image-webp", "xlsm"),
  ...
  rtf: docTargetsExcept("rtf").concat("odp", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp", "image-psd", "image-tiff"),
  odt: docTargetsExcept("odt").concat("fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  odp: docTargetsExcept("pptx").concat("pptx", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  pptx: docTargetsExcept("pptx").concat("fb2", "odp", "pptm", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  pptm: docTargetsExcept().concat("pptx", "odp", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  potx: docTargetsExcept().concat("pptx", "odp", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  ppsx: docTargetsExcept().concat("pptx", "odp", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  fb2: docTargetsExcept().concat("image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  mobi: docTargetsExcept().concat("image-png", "image-jpeg", "image-gif", "image-svg", "image-webp", "azw"),
  azw: docTargetsExcept().concat("image-png", "image-jpeg", "image-gif", "image-svg", "image-webp", "image-avif", "image-bmp", "mobi", "fb2"),
  prc: docTargetsExcept().concat("image-png", "image-jpeg", "image-gif", "image-svg", "image-webp", "mobi", "azw", "fb2"),
  htmlz: docTargetsExcept().concat("fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  txtz: docTargetsExcept().concat("image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  cbz: ["pdf", "epub"],
  dxf: ["pdf"],
  html: ["markdown", "text", "pdf", "docx", "epub", "csv", "xlsx", "rtf", "odt", "pptx", "fb2", "rst", "tex", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp", "txt-base64", "txt-hex"],
  markdown: ["html", "text", "pdf", "docx", "epub", "csv", "xlsx", "rtf", "odt", "odp", "pptx", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp", "txt-base64", "txt-hex"],
  rst: docTargetsExcept().concat("fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  tex: docTargetsExcept().concat("fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  abw: docTargetsExcept().concat("fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  zabw: docTargetsExcept().concat("fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  oeb: docTargetsExcept().concat("fb2", "image-png", "image-jpeg"),
  pml: docTargetsExcept().concat("fb2", "image-png", "image-jpeg"),
  text: ["txt-base64", "txt-hex", "txt-url", "pdf", "docx", "dotx", "html", "markdown", "rst", "tex", "epub", "rtf", "odt", "odp", "pptx", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"],
  csv: [...tableTargetsExcept("csv"), "jsonl", "image-png", "image-jpeg", "image-webp", "image-gif", "image-svg"],
