...
export const MATRIX: Record<FileType, TargetFormat[]> = {
  ...
  potx: docTargetsExcept().concat("pptx", "fb2", "image-png", "image-jpeg"),
  ppsx: docTargetsExcept().concat("pptx", "fb2", "image-png", "image-jpeg"),
  ...
  htmlz: docTargetsExcept().concat("image-png", "image-jpeg"),
