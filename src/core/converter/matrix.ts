...
export const MATRIX: Record<FileType, TargetFormat[]> = {
  ...
  txtz: docTargetsExcept().concat("image-png", "image-jpeg"),
  cbz: ["pdf", "epub"],
  dxf: ["pdf"],
  ...
  text: ["txt-base64", "txt-hex", "txt-url", "pdf", "docx", "html", "markdown", "epub", "rtf", "odt", "odp", "pptx", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"],
