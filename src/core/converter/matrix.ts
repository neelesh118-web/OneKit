...
export const MATRIX: Record<FileType, TargetFormat[]> = {
  ...
  pptm: docTargetsExcept().concat("pptx", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  potx: docTargetsExcept().concat("pptx", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  ppsx: docTargetsExcept().concat("pptx", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp"),
  ...
  prc: docTargetsExcept().concat("image-png", "image-jpeg", "image-gif", "image-svg", "image-webp", "mobi"),
  ...
  pml: docTargetsExcept().concat("image-png", "image-jpeg"),
