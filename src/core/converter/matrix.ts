...
export const MATRIX: Record<FileType, TargetFormat[]> = {
  ...
  docm: ["html", "markdown", "text", "pdf", "docx", "epub", "rtf", "odt", "pptx", "txt-base64", "txt-hex"],
  dotx: ["html", "markdown", "text", "pdf", "docx", "epub", "rtf", "odt", "pptx", "txt-base64", "txt-hex"],
  ...
  pptm: docTargetsExcept().concat("pptx"),
  potx: docTargetsExcept().concat("pptx"),
  ppsx: docTargetsExcept().concat("pptx"),
