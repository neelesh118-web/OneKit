...
export const MATRIX: Record<FileType, TargetFormat[]> = {
  ...
  docx: ["html", "markdown", "text", "pdf", "dotx", "epub", "csv", "xlsx", "rtf", "odt", "pptx", "odp", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp", "txt-base64", "txt-hex"],
  docm: ["html", "markdown", "text", "pdf", "docx", "epub", "rtf", "odt", "pptx", "fb2", "image-png", "image-jpeg", "txt-base64", "txt-hex"],
  dotx: ["html", "markdown", "text", "pdf", "docx", "epub", "rtf", "odt", "pptx", "fb2", "image-png", "image-jpeg", "txt-base64", "txt-hex"],
  ...
  cbz: ["pdf", "epub"],
  dxf: ["pdf"],
  html: ["markdown", "text", "pdf", "docx", "epub", "csv", "xlsx", "rtf", "odt", "pptx", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp", "txt-base64", "txt-hex"],
