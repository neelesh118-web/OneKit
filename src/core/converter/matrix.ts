...
export const MATRIX: Record<FileType, TargetFormat[]> = {
  ...
  docx: ["html", "markdown", "text", "pdf", "epub", "csv", "xlsx", "rtf", "odt", "pptx", "odp", "fb2", "image-png", "image-jpeg", "image-gif", "image-svg", "image-webp", "txt-base64", "txt-hex"],
  ...
  abw: docTargetsExcept().concat("fb2", "image-png", "image-jpeg", "image-gif"),
