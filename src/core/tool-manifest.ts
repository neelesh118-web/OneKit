...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    icon: "🔄",
    tab: "convert",
    description: "Convert files locally (one or a whole batch, save individually or bundled into one ZIP): images ↔ PNG/JPEG/WebP/AVIF/GIF with quality and max-size controls, PDF/DOCX/EPUB → text/Markdown/HTML, XLSX ↔ CSV/JSON, JSON ↔ YAML/XML/CSV, ZIP/TAR/GZIP, fonts TTF/WOFF/WOFF2, audio → WAV, WAV → MP3. Nothing is uploaded."
  }
];
