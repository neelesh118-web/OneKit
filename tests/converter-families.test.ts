...
describe("matrix consistency", () => {
  ...
  it("has no self-targets (image re-encodes excepted)", () => {
    ...
    const reencode = new Set(["image-png", "image-jpeg", "image-webp", "image-gif", "image-bmp", "image-avif", "image-tiff", "image-svg", "image-qoi", "image-farbfeld", "image-pcx", "audio-wav", "audio-aiff", "audio-au", "audio-ogg", "audio-mp3", "audio-mp4", "audio-flac", "audio-midi", "video-mp4", "video-webm", "video-mov"]);
    for (const [source, targets] of Object.entries(MATRIX)) {
