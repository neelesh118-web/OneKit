...
export default defineConfig({
  ...
  manifest: {
    ...
    name: "OneKit — Local Browser Toolbox (89 tools, no cloud)",
    description:
      "89 local tools: history search, AI chat vault, session backup, tab snooze, focus sessions, TOTP 2FA authenticator, local password vault, video speed controller, tab recorder, OCR, spell-checker, todo list, secure notes, reminders, link collector, barcode generator, file converter, PDF tools, citation generator, API tester, new-tab dashboard — 100% on-device, free forever.",
